...
DIVISION_ALL_OPEN = {**DIVISION_OPEN_PRO, **DIVISION_OPEN_PRO_MASTERS, **
                     DIVISION_OPEN_AMATEUR, **DIVISION_OPEN_AMATEUR_MASTERS, **DIVISION_OPEN_JUNIOR}
DIVISION_ALL_WOMEN = {**DIVISION_WOMEN_PRO, **DIVISION_WOMEN_PRO_MASTERS, **
                      DIVISION_WOMEN_AMATEUR, **DIVISION_WOMEN_AMATEUR_MASTERS, **DIVISION_WOMEN_JUNIOR}
...
DIVISION_ALL_OPEN_AMATEUR = {
    **DIVISION_OPEN_AMATEUR, **DIVISION_OPEN_AMATEUR_MASTERS}
DIVISION_ALL_OPEN_MASTERS = {
    **DIVISION_OPEN_PRO_MASTERS, **DIVISION_OPEN_AMATEUR_MASTERS}
DIVISION_ALL_WOMEN_AMATEUR = {
    **DIVISION_WOMEN_AMATEUR, **DIVISION_WOMEN_AMATEUR_MASTERS}
DIVISION_ALL_WOMEN_MASTERS = {
    **DIVISION_WOMEN_PRO_MASTERS, **DIVISION_WOMEN_AMATEUR_MASTERS}
DIVISION_ALL_MASTERS = {
    **DIVISION_ALL_OPEN_MASTERS, **DIVISION_ALL_WOMEN_MASTERS}
DIVISION_ALL_AMATEUR = {
    **DIVISION_ALL_OPEN_AMATEUR, **DIVISION_ALL_WOMEN_AMATEUR}
