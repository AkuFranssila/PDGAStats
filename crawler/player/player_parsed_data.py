...
class PlayerParsedData:
    """
    Collected specific data from raw data without any formatting.
    """

    def __init__(self, player_raw_data: json) -> None:
        self.pdga_number = player_raw_data.get("pdga_number")
        self.crawl_datetime = player_raw_data.get("crawl_datetime")
        self.raw_data = player_raw_data.get("data")
